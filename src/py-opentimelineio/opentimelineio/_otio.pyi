...
class Clip(Item):
    ...
    def __init__(self, name: str = ..., media_reference: MediaReference = ..., source_range: Optional[opentimelineio._opentime.TimeRange] = ..., metadata: object = ..., active_media_reference: str = ...) -> None: ...
...
class Composition(Item):
    def __init__(self, name: str = ..., children: object = ..., source_range: Optional[opentimelineio._opentime.TimeRange] = ..., metadata: object = ...) -> None: ...
    ...
    def children_if(self, descended_from_type: object = ..., search_range: Optional[opentimelineio._opentime.TimeRange] = ..., shallow_search: bool = ...) -> List[SerializableObject]: ...
    ...
    def trim_child_range(self, child_range: opentimelineio._opentime.TimeRange) -> Optional[opentimelineio._opentime.TimeRange]: ...
    def trimmed_child_range(self, child_range: opentimelineio._opentime.TimeRange) -> Optional[opentimelineio._opentime.TimeRange]: ...
    def trimmed_range_of_child(self, child: Composable, reference_space: Composable = ...) -> Optional[opentimelineio._opentime.TimeRange]: ...
...
class EffectVector:
    def __init__(self) -> None: ...
    def __internal_insert(self, index: int, item: Effect) -> None: ...
    def __internal_delitem__(self, index: int) -> None: ...
    def __internal_getitem__(self, index: int) -> Effect: ...
    def __internal_setitem__(self, index: int, item: Effect) -> None: ...
...
class ExternalReference(MediaReference):
    target_url: str
    def __init__(self, target_url: str = ..., available_range: Optional[opentimelineio._opentime.TimeRange] = ..., metadata: object = ..., available_image_bounds: Optional[Box2d] = ...) -> None: ...
...
class Gap(Item):
    @overload
    def __init__(self, name: str = ..., source_range: opentimelineio._opentime.TimeRange = ..., effects: object = ..., markers: object = ..., metadata: object = ...) -> None: ...
    @overload
    def __init__(self, name: str = ..., duration: opentimelineio._opentime.RationalTime = ..., effects: object = ..., markers: object = ..., metadata: object = ...) -> None: ...

class GeneratorReference(MediaReference):
    generator_kind: str
    def __init__(self, name: str = ..., generator_kind: str = ..., available_range: Optional[opentimelineio._opentime.TimeRange] = ..., parameters: object = ..., metadata: object = ..., available_image_bounds: Optional[Box2d] = ...) -> None: ...
    @property
...
class ImageSequenceReference(MediaReference):
    ...
    start_frame: int
    target_url_base: str
    def __init__(self, target_url_base: str = ..., name_prefix: str = ..., name_suffix: str = ..., start_frame: int = ..., frame_step: int = ..., rate: float = ..., frame_zero_padding: int = ..., missing_frame_policy: ImageSequenceReference.MissingFramePolicy = ..., available_range: Optional[opentimelineio._opentime.TimeRange] = ..., metadata: object = ..., available_image_bounds: Optional[Box2d] = ...) -> None: ...
...
class Item(Composable):
    enabled: bool
    source_range: Optional[opentimelineio._opentime.TimeRange]
    def __init__(self, name: str = ..., source_range: Optional[opentimelineio._opentime.TimeRange] = ..., effects: object = ..., markers: object = ..., enabled: bool = ..., metadata: object = ...) -> None: ...
    ...
    def trimmed_range_in_parent(self) -> Optional[opentimelineio._opentime.TimeRange]: ...
    def visible_range(self) -> opentimelineio._opentime.TimeRange: ...
    @property
    def available_image_bounds(self) -> Optional[Box2d]: ...
    @property
...
class Marker(SerializableObjectWithMetadata):
    ...
    def __init__(self, name: Optional[str] = ..., marked_range: opentimelineio._opentime.TimeRange = ..., color: str = ..., metadata: object = ...) -> None: ...

class MarkerVector:
    def __init__(self) -> None: ...
    def __internal_insert(self, index: int, item: Marker) -> None: ...
    def __internal_delitem__(self, index: int) -> None: ...
    def __internal_getitem__(self, index: int) -> Marker: ...
    def __internal_setitem__(self, index: int, item: Marker) -> None: ...
...
class MediaReference(SerializableObjectWithMetadata):
    available_image_bounds: Optional[Box2d]
    available_range: Optional[opentimelineio._opentime.TimeRange]
    def __init__(self, name: str = ..., available_range: Optional[opentimelineio._opentime.TimeRange] = ..., metadata: object = ..., available_image_bounds: Optional[Box2d] = ...) -> None: ...
    @property
    def is_missing_reference(self) -> bool: ...

class MissingReference(MediaReference):
    def __init__(self, name: Optional[str] = ..., available_range: Optional[opentimelineio._opentime.TimeRange] = ..., metadata: object = ..., available_image_bounds: Optional[Box2d] = ...) -> None: ...
...
class SerializableCollection(SerializableObjectWithMetadata):
    def __init__(self, name: str = ..., children: object = ..., metadata: object = ...) -> None: ...
    def __internal_insert(self, index: int, item: SerializableObject) -> None: ...
    def children_if(self, descended_from_type: object = ..., search_range: Optional[opentimelineio._opentime.TimeRange] = ..., shallow_search: bool = ...) -> List[SerializableObject]: ...
    def clip_if(self, search_range: Optional[opentimelineio._opentime.TimeRange] = ..., shallow_search: bool = ...) -> List[SerializableObject]: ...
    def __internal_delitem__(self, index: int) -> None: ...
...
class SerializableObject:
    ...
    def from_json_file(self, *args, **kwargs) -> Any: ...
    def from_json_string(self, *args, **kwargs) -> Any: ...
...
class Stack(Composition):
    def __init__(self, name: Optional[str] = ..., children: object = ..., source_range: Optional[opentimelineio._opentime.TimeRange] = ..., markers: object = ..., effects: object = ..., metadata: object = ...) -> None: ...
    def clip_if(self, search_range: Optional[opentimelineio._opentime.TimeRange] = ..., shallow_search: bool = ...) -> List[SerializableObject]: ...
...
class Timeline(SerializableObjectWithMetadata):
    global_start_time: Optional[opentimelineio._opentime.RationalTime]
    tracks: Stack
    def __init__(self, name: str = ..., tracks: object = ..., global_start_time: Optional[opentimelineio._opentime.RationalTime] = ..., metadata: object = ...) -> None: ...
...
class Track(Composition):
    ...
    class NeighborGapPolicy:
        ...
        def value(self) -> int: ...
    kind: str
    def __init__(self, name: Optional[str] = ..., children: object = ..., source_range: Optional[opentimelineio._opentime.TimeRange] = ..., kind: str = ..., metadata: object = ...) -> None: ...
    def clip_if(self, search_range: Optional[opentimelineio._opentime.TimeRange] = ..., shallow_search: bool = ...) -> List[SerializableObject]: ...
...
class Transition(Composable):
    ...
    def duration(self) -> opentimelineio._opentime.RationalTime: ...
    def range_in_parent(self) -> Optional[opentimelineio._opentime.TimeRange]: ...
    def trimmed_range_in_parent(self) -> Optional[opentimelineio._opentime.TimeRange]: ...
...
class V2d:
    ...
    def baseTypeEpsilon(self, *args, **kwargs) -> Any: ...
    def baseTypeLowest(self, *args, **kwargs) -> Any: ...
    def baseTypeMax(self, *args, **kwargs) -> Any: ...
    def baseTypeSmallest(self, *args, **kwargs) -> Any: ...
...
@overload
def flatten_stack(tracks: object) -> Track: ...
